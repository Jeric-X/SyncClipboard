...
public class ConfigManager : ConfigBase
{
    ...
    {
#if MACOS
        new MenuItem(I18n.Strings.OpenConfigFile, () => Process.Start("open", Env.AppDataDirectory)),
        new MenuItem(I18n.Strings.ReloadConfigFile, Load),
        new MenuItem(I18n.Strings.OpenConfigFileFolder, () => Process.Start("open", $"-R \"{Path}\""))
#endif
#if WINDOWS
