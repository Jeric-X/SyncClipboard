...
- Target framework: desktop projects use `net10.0` (with platform-qualified entry targets); Core, Shared, Server.Core, Server and Core tests remain `net8.0` during the staged migration.
